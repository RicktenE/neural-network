...
act_func = 'softplus'               # Activation function used in training and testing
learning_rate = 0.001           # the learning rate of the training
patience = 500                  # the amount of epochs the training has to continue after finding the lowest val_loss
...
if  train_ == 1 and test_ == 1:
    ...
    test(wdw,act_func,date,exclude_size,date_test,test_size,nodes)
